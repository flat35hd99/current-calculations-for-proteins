...
manual = {
    "sele": (
        "Output an irEC file with removed or kept only selected "
    ...
    "nohelix": "",
    "noloop": "",
    "noneighbor": ("Remove residue pairs that indicate covalent " "peptide bonds."),
    "threshold": "",
}
...
def arg_sel_helix(parser=None):
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "[Optional] irEC data filename. If not " "provided requires standard input."
        ),
    )
