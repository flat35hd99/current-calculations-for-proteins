...
class Setting(SettingBase):
    ...
    input = Section(
        ...
        first_last_interval=List(
            default=(0, -1, 1),
            require=False,
            value_type=Int,
            desc=(
                "The first, last and interval step to read coordinates and "
        ...
        group_file=File(
            ...
            allow_glob=False,
            desc=(
                "The group file path to define group."
    ...
    input_amber = Section(
        ...
        topology_file=File(
            default="", require=True, allow_glob=False, desc="Topology file path."
        ),
        ...
        restart_file=File(
            default="", require=False, allow_glob=False, desc="Restart file path."
        ),
        coordinate_format=Choice(
            default="ascii",
            require=False,
    ...
    volume = Section(
        ...
        voronoi_cutoff=Float(
            ...
            require=False,
            desc=(
                "The cutoff length that the voronoi calculation finds out"
                "neighbour candidate particles."
            ),
        ),
        voronoi_no_hydrogen=Bool(
            default=False,
            require=False,
            desc=(
                "Flag to determine whether include hydrogen atoms"
                "for the voronoi calculation."
            ),
        ),
        voronoi_solvation=Choice(
            default="none",
            require=False,
            desc=(
                "The kind of solvation system to sink the target system "
        ...
        voronoi_probe_length=Float(
            default=2.4,
            require=False,
            desc=(
                "The probe length of the solvation for the voronoi method."
                "The water molecules within the probe length "
                "from the system are removed."
            ),
        ),
        voronoi_output_solvation_file=File(
            default="",
            require=False,
            allow_glob=False,
            desc=(
                "The file path to write out the solvation pdb data in the "
                'case of voronoi_solvation == "none".'
                "If the file path is not given, writing out is not performed."
            ),
        ),
        output_volume_file=File(
            default="",
            require=False,
            allow_glob=False,
            desc=(
    ...
    curp = Section(
        ...
        method=Choice(
            ...
            values=["energy-flux", "momentum-current", "microcanonical", "heat-flux"],
        ),
        ...
        flux_grain=Choice(
            ...
            value_type=String,
            desc=(
                "The grain to calculate the flux."
        ...
        decomp_group_current=Bool(
            default=False,
            require=False,
            desc=(
                "Flag whether decompose the group current into inside and "
                "outside contributions of group region."
                "This option is used for calculating momentum current"
            ),
        ),
        group_pair_file=File(
            default="",
            require=False,
            allow_glob=False,
            desc=(
                "Path to file to define group pair. "
                "If you didn't given, all of pairs within the targets "
                "will be calculated."
            ),
        ),
        coulomb_method=Choice(
            default="cutoff",
            require=False,
        ...
        #     value_type=String),
        enable_inverse_pair=Bool(
            default=False,
            require=False,
            desc=(
                "Calculate and write out inverse pairs j <- i for flux "
        ...
        remove_trans=Bool(
            ...
            require=False,
            desc=(
                "Remove the coordinate and velocity of translation "
    ...
    dynamics = Section(
        ...
        num_steps=Int(default=1, require=True, desc="The number of integration steps."),
        crds_file=File(
            default="",
            require=False,
            allow_glob=False,
            desc=(
                "The file path to write out the coordinates trajectory. "
        ...
        vels_file=File(
            ...
            allow_glob=False,
            desc=(
                "The file path to write out the velocities trajectory. "
                "If empty, then don't write."
            ),
        ),
        crds_frequency=Int(
    ...
    output = Section(
        ...
        decomp=Bool(
            ...
            require=False,
            desc=(
                "Flag whether decompose the total current or flux "
        ...
        frequency=Int(
            default=0,
            require=False,
            desc=("The frequency to create new file to write " "the additional file."),
        ),
        compress=Bool(
            default=False,
            require=False,
            desc=(
                "Flag whether compress with gnu zip, "
        ...
        energy_decomp=Bool(
            ...
            require=False,
            desc=(
                "Flag whether decompose the total energy "
                "to bonded, coulomb, and van der Waals interaction."
            ),
        ),
        energy_freqency=Int(
        ...
        energy_compress=Bool(
            default=True,
            require=False,
            desc=(
                "Flag whether compress with gnu zip for energy_file, "
                'then the extension of the file name became ".gz".'
            ),
        ),
