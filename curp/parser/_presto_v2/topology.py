...
class TopologyParser:
    ...
    def split_content(self, tpl_file):
        ...
        return dict(
            mol=mol_lines,
            atom=atom_lines_list,
            bond=bond_lines_list,
            angle=angle_lines_list,
            torsion=torsion_lines_list,
    ...
    def parse_mol(self, lines):
        ...
        return dict(name=None, mol_names=mol_names, num_molecules=num_molecules)
...
class Format2Amber99Converter(ConverterBase):
        ...
        for minfo in self.get_mol_info():
            ...
            if atom_info:
                ...
                for imol in range(minfo["nmol"]):
                    ...
                    ids.extend(resid + nres_last for resid in atom_info["res_ids"])
                    nres_last = ids[-1]
    ...
    def _convert_bond(self):
            ...
            if bnd_info:
                ...
                for imol in range(minfo["nmol"]):
                    ...
                    for iatoms in bnd_info["two_atoms"]:
                        two_atoms.append([iatoms[i] + cur_natom for i in range(2)])
        ...
        self.__bond_info = dict(
            two_atoms=two_atoms, force_consts=force_consts, length_eqs=length_eqs
        )
    ...
    def _convert_angle(self):
            ...
            if ang_info:
                ...
                for imol in range(minfo["nmol"]):
                    ...
                    for iatoms in ang_info["three_atoms"]:
                        three_atoms.append([iatoms[i] + cur_natom for i in range(3)])
        ...
        self.__angle_info = dict(
            three_atoms=three_atoms, force_consts=force_consts, theta_eqs=theta_eqs
        )
            ...
            if tor_info:
                ...
                for imol in range(minfo["nmol"]):
                    ...
                    for iatoms in tor_info["four_atoms"]:
                        four_atoms.append([iatoms[i] + cur_natom for i in range(4)])
