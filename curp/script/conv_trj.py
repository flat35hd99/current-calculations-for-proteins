...
def gen_trj(
    ...
    **kwds
    ...
    trj = gen_trajectory_multi(
        trj_fns_list, fmts, natom, fst_lst_int_list, trj_type, use_pbc=use_pbc
    )

    return trj


def gen_trajectory_multi(
    trj_fns_list,
    trj_fmts,
    natom,
    fst_lst_int_list,
...
def do_convert_only(
    ...
    **kwds
    ...
    # write trajectory
    writer = TrjWriter(output_trj_fn, output_trj_fmt, dt, is_vel, output_fst_lst_int)
