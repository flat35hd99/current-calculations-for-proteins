...
def do_distance(
    tpl, trj, trj_type, dist_format=None, dist_cutoff=5.0, dist_method="com", **kwds
):
    ...
    if dist_method == "com":
        mod.method = 1
    elif dist_method == "nearest":
        mod.method = 2
    elif dist_method == "farthest":
        mod.method = 3
    else:
        pass
...
def load_mask(fn):
    ...
    with open(fn, "rb") as file:
        ids_str = (line.split()[1] for line in file if line.startswith("ATOM"))
