...
class SectionNotFoundError(exception.CurpException):
    pass


class ParserError(exception.CurpException):
    pass
...
def get_group_iatoms_pairs(setting, target_atoms, res_info, atom_info):
    ...
    if method == "none":
        ...
        gname_iatoms_pairs = list(
            gen_group_pairs_with_target(
        ...
        gname_iatoms_pairs = list(
            gen_group_pairs_with_target(gen_united_group(atom_info), iatm_to_itars)
        )
